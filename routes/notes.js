...
const fetchuser = require('../middleware/fetchuser'); // Path is relative to routes/
const Note = require('../models/Note');             // Path is relative to routes/
...
router.put('/updatenote/:id', fetchuser, async (req, res) => {
    ...
    try {
        ...
        if (note.user.toString() !== req.user.id) {
            return res.status(401).send("Access Denied: Not your note");
        }
